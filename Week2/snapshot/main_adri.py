...
from models import SimpleModel, DeeperModel, PyramidalMLP, BottleneckMLP
...
def plot_image(i, predictions_array, true_labels, images):
    ...
    plt.xlabel(f"Predicción: {predicted_label} (GT: {true_label})", color=color)
...
def tablaAciertos(predictions, labels, images, save_path):
    numrows = 5
    numcols = 3
